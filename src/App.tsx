...
const PROJECTS = [
  {
    ...
    thumbnail: '/project_erp_cover.png',
    demoUrl: 'https://continental-tea-dev.h2bis.com',
    ...
    screenshots: ['/project_erp_cover.png','/project_erp_ss_01.png', '/project_erp_ss_02.png', '/project_erp_ss_03.png'],
  },
  {
    id: 'elitecuts',
    title: 'EliteCuts',
    ...
    screenshots: ['/project_salon_cover.png','/project_salon_ss_01.png', '/project_salon_ss_02.png', '/project_salon_ss_03.png'],
  },
  {
    id: 'fitbook',
    title: 'FitBook',
    ...
    screenshots: ['/project_gym_cover.png','/project_gym_ss_01.png', '/project_gym_ss_02.png', '/project_gym_ss_03.png'],
  },
  {
    id: 'mcp-hub',
    title: 'MCP Hub Platform',
    tagline: 'Centralized AI integration hub for connecting models, tools, and enterprise systems',
    tags: ['AI Integration', 'MCP Protocol', 'Node.js', 'React', 'Docker', 'API Gateway', 'LLM Tools'],
    thumbnail: '/project_mcp_cover.png',
    demoUrl: null as string | null,
    githubUrl: null as string | null,
    problem: 'Modern AI applications require integration with multiple tools, APIs, and data sources — but each integration demands custom implementation, security becomes complex, and real-time workflows are hard to manage. The result is fragmented, hard-to-maintain AI systems that can\'t scale across services.',
    solution: 'MCP Hub acts as a central orchestration layer that connects AI models with external tools through a unified interface. It standardises integrations, manages tool discovery, and enables secure, scalable AI workflows — one hub to manage all AI-tool interactions.',
    features: [
      { emoji: '🔗', title: 'Unified API Gateway', desc: 'Single entry point routing requests across multiple tools and services' },
      { emoji: '⚙️', title: 'Dynamic Tool Discovery', desc: 'Auto-discover and register integrations without manual wiring' },
      { emoji: '🔄', title: 'Real-time Orchestration', desc: 'Live workflow execution between AI models and external services' },
      { emoji: '🔐', title: 'Secure Access Control', desc: 'Token-based auth and fine-grained permission management' },
      { emoji: '📊', title: 'Monitoring Dashboard', desc: 'Centralised visibility into tool usage, latency, and errors' },
      { emoji: '🤖', title: 'AI-Agent Architecture', desc: 'Designed for LLM agents — tool-use, context passing, and chaining' },
      { emoji: '🔌', title: 'Enterprise Integrations', desc: 'Connect databases, REST APIs, and third-party services seamlessly' },
      { emoji: '🚀', title: 'Multi-service Execution', desc: 'Scalable parallel execution across distributed tool endpoints' },
    ],
    techStack: [
      { label: 'Frontend', color: 'var(--tint)', items: ['React', 'TypeScript'] },
      { label: 'Backend', color: 'var(--tint-indigo)', items: ['Node.js', 'Express', 'REST APIs'] },
      { label: 'AI / Integration', color: 'var(--tint-purple)', items: ['Model Context Protocol (MCP)', 'External API Integrations'] },
      { label: 'DevOps', color: 'var(--tint-teal)', items: ['Docker', 'CI/CD Pipelines'] },
    ],
    highlights: [
      'Designed a centralised integration hub connecting AI models with diverse external tools',
      'Implemented a unified routing layer abstracting complexity of multiple tool APIs',
      'Enabled real-time bidirectional communication between LLM agents and services',
      'Built secure token-based authentication flows with scoped access per integration',
      'Reduced per-tool integration overhead using standardised MCP architecture',
      'Developed a scalable orchestration engine supporting multi-tool parallel workflows',
    ],
    screenshots: ['/project_mcp_cover.png','/project_gym_ss_01.png', '/project_gym_ss_02.png', '/project_gym_ss_03.png'],
  },
]
